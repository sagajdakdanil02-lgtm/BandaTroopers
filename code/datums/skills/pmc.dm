...
/datum/skills/pmc/medic
	...
	skills = list(
		...
		SKILL_MEDICAL = SKILL_MEDICAL_MASTER, // SS220 EDIT: PMC medics follow the BT elite medic ladder
		// SKILL_SURGERY = SKILL_SURGERY_NOVICE,
		SKILL_SURGERY = SKILL_SURGERY_EXPERT, // SS220 EDIT: PMC medics follow the BT elite medic ladder
		SKILL_ENDURANCE = SKILL_ENDURANCE_WEAK,
	)
...
/datum/skills/pmc/medic/chem
	...
	skills = list(
		...
		SKILL_ENGINEER = SKILL_ENGINEER_TRAINED,
		// SKILL_MEDICAL = SKILL_MEDICAL_MEDIC,
		SKILL_MEDICAL = SKILL_MEDICAL_MASTER, // SS220 EDIT: PMC investigators follow the BT elite medic ladder
		// SKILL_SURGERY = SKILL_SURGERY_NOVICE,
		SKILL_SURGERY = SKILL_SURGERY_EXPERT, // SS220 EDIT: PMC investigators follow the BT elite medic ladder
		SKILL_ENDURANCE = SKILL_ENDURANCE_WEAK,
