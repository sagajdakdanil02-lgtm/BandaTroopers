...
/datum/skills/contractor/medic
	...
	skills = list(
		...
		SKILL_MEDICAL = SKILL_MEDICAL_MASTER, // SS220 EDIT: contractor medics follow the BT elite medic ladder
		// SKILL_SURGERY = SKILL_SURGERY_TRAINED,
		SKILL_SURGERY = SKILL_SURGERY_EXPERT, // SS220 EDIT: contractor medics follow the BT elite medic ladder
		SKILL_VEHICLE = SKILL_VEHICLE_LARGE,
		SKILL_ENDURANCE = SKILL_ENDURANCE_WEAK,
		SKILL_MELEE_WEAPONS = SKILL_MELEE_TRAINED,
		SKILL_CQC = SKILL_CQC_TRAINED,
